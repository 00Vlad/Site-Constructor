...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/simple_image.jpg":[function(require,module,exports) {
module.exports = "/simple_image.32f9f08b.jpg";
  ...
  _createClass(TitleBlock, [{
    ...
    value: function toHTML() {
      var _this$options = this.options,
          ...
          styles = _this$options.styles; // деструктуризация
  ...
  _createClass(TextBlock, [{
    ...
    value: function toHTML() {
      var _this$options2 = this.options,
          tag = _this$options2.tag,
          rowStyles = _this$options2.rowStyles,
          styles = _this$options2.styles; // деструктуризация

      return (0, _utils.row)((0, _utils.col)("<".concat(tag, " style=\"").concat((0, _utils.css)(styles), "\">").concat(this.value, "</").concat(tag, ">")), (0, _utils.css)(rowStyles));
    }
  }]);
  ...
  _createClass(ImageBlock, [{
    ...
    value: function toHTML() {
      var _this$options3 = this.options,
          ...
          imageStyles = _this$options3.imageStyles; // деструктуризация
...
var _simple_image = _interopRequireDefault(require("./assets/simple_image.jpg"));
...
var model = [new _blocks.TitleBlock("Pure JavaScript Website Builder", {
...
}), new _blocks.ImageBlock(_simple_image.default, {
  styles: {
    "margin-top": "1rem"
  },
  imageStyles: {
  ...
  rowStyles: {
    background: "linear-gradient(90deg, rgba(44,56,145,1) 0%, rgba(54,21,21,1) 91%)",
    "box-shadow": "0px -3px 10px -1px rgba(0,0,0,0.75)",
    padding: "1rem",
    "margin-top": "1rem"
  }
}), new _blocks.ColumnsBlock(colTextArr, {
  styles: {
    background: "#944336",
    color: "white",
    padding: "1rem"
...
exports.model = model;
},{"./assets/simple_image.jpg":"assets/simple_image.jpg","./classes/blocks":"classes/blocks.js"}],"classes/sidebar.js":[function(require,module,exports) {
"use strict";
...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    key: "template",
    get: function get() {
      return [(0, _utils.block)("title"), (0, _utils.block)("text"), (0, _utils.block)("column")].join("");
    }
  }]);
